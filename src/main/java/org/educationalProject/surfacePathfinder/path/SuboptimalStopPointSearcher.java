...
public class SuboptimalStopPointSearcher implements Runnable {
    ...
    public SuboptimalStopPointSearcher(AtomicInteger stopPointSource, AtomicInteger stopPointDestination,
                             AtomicBoolean stop,
